...
class ChunkerConfigORM(Base):
    ...
    rag_configs: Mapped[list["RAGConfigORM"]] = relationship(back_populates="chunker")  # noqa: F821  # type: ignore[name-defined]
    chunks: Mapped[list["ChunkORM"]] = relationship(back_populates="chunker")  # noqa: F821  # type: ignore[name-defined]
